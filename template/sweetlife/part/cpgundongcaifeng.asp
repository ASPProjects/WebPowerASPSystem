<div id="demo" style="width:735px; overflow:hidden; margin:0px auto">
...
sql = "Select  top 8 * From Qianbo_Products where ViewFlag  and ID"
rs.Open sql, conn, 1, 1
IF Not rs.eof Then
while Not rs.Eof
%>
<td><table width="120" border="0" cellspacing="0" cellpadding="0">
<tr><td valign="top" background="images/indpicbg.jpg"><table width="120" border="0" cellspacing="0" cellpadding="0" style="margin:5px">
<tr>
<td height="5"></td>
</tr>
<tr>
...
<style type="text/css">
#demo img{width:162px;height:162px;vertical-align: middle;}
</style>